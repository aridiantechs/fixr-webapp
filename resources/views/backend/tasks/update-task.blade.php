                            ...
                            <form action="{{ route('backend.tasks.update', ['task_id' => $task->id]) }}" method="POST">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="automation_type"
                                                ...
                                                {{ old('automation_type', $task->automation_type ?? '') == 'recurring' ? 'checked' : '' }}>
                                ...
                                <div id="recurring_task_fields_container" class="d-none">
                                    <div class="mb-3">
                                        ...
                                        <select id="recurring_start_week_day" class="form-control"
                                            ...
                                            @foreach ($week_days as $day)
                                                <option value="{{ $day }}"
                                                    {{ old('recurring_start_week_day') || $task->recurring_start_week_day === $day ? 'selected' : '' }}>
                                                    {{ ucfirst($day) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="recurring_end_week_day" class="form-control"
                                            ...
                                            @foreach ($week_days as $day)
                                                <option value="{{ $day }}"
                                                    {{ old('recurring_end_week_day') || $task->recurring_end_week_day === $day ? 'selected' : '' }}>
                                                    {{ ucfirst($day) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="time" class="form-control" id="recurring_start_time"
                                            ...
                                            value="{{ old('recurring_start_time', $task->recurring_start_time) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="time" class="form-control" id="recurring_end_time"
                                            ...
                                            value="{{ old('recurring_end_time', $task->recurring_end_time) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="task_keywords" name="keywords"
                                        aria-describedby="Task Keywords" value="{{ old('keywords', $task->keywords) }}">
                                ...
                                <div class="mt-2 mb-2">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="automation_status"
                                            ...
                                            {{ old('automation_status') === 'disabled' || $task->is_enabled == '0' ? 'checked' : '' }}>
